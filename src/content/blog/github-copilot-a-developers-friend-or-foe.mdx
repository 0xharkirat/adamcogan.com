...
heroImage: "/media/2022/12/Github-copilot-friend-or-foe-Blog-Banner.jpg"
author: "Adam Cogan"
categories: ["github"]
...
<Figure src="/media/2022/12/image-1.png" alt="Graph showing how many user are currently using GitHub Copilot, more than 30/58" caption="Figure: 30 vs 28 – there are more people using it, than not using GitHub Copilot… and 6 of them have used it for more than a year (purple) – impressive" />

<Figure src="/media/2022/12/image-4.png" alt="The locations GitHub Copilot is being used - mostly APi and frontend" caption="Figure: Where the SSW developers have used GitHub Copilot – API (orange) and Frontend (blue) are the most popular" />
