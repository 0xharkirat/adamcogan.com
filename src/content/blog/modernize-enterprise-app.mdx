...
heroImage: "/media/2024/08/Modernizing-TimePro-to-NET-8-Blog-Banner-1.png"
author: "Adam Cogan"
...
<Figure src="/media/2024/08/New-chart.png" alt="" caption="Figure: TimePro lost 75% of it’s code 👑 – Before (.NET 4.8) vs Migrated (.NET 8) – see data at the end of the blog" />
...
<Figure src="/media/2024/08/TimePro-speedy.png" alt="" caption="Figure: (graph generated by ChatGPT) – The stats give TimePro context to other enterprise .NET projects" />
