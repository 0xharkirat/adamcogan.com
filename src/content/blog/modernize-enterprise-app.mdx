...
<YouTubeEmbed videoId="vPa1bX-ZQ38" caption="Video: TimePro – Moving to .NET 8 and removing 1 million lines of legacy codeOur team replaced some legacy CRM NuGet packages, to new Power Platform NuGet Packages and that meant we had a commit that reduced the codebase by over 1 millions lines of code. Can you beat that?" />
