...
heroImage: "/media/2021/11/Blog-Banner-BDD-Automated-Testing.jpg"
author: "Adam Cogan"
...
<Figure src="/media/2021/11/BDD-cartoon-1-scaled.jpg" alt="Figure of the normal development process" caption="Figure: What is the cost of translation? BDD helps branch the communication between the 3 different languages" />
...
<Figure src="/media/2021/11/image.png" alt="Good example of Gherkin syntax scenarios" caption="Figure: Good example – Gherkin syntax scenarios (Given, When, Then)" />

Once you have your scenarios lined up, you should begin to write the test steps for each scenario….

<Figure src="/media/2021/11/image-1.png" alt="Good example of test steps to run" caption="Figure: Good example – test steps to run, matching the Gherkin Syntax" />
