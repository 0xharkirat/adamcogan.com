...
heroImage: "/media/2021/08/Blog-Banner-Multi-Select.webp"
author: "Adam Cogan"
...
<Figure src="/media/2021/08/image.webp" alt="Bad example of a form with no multiselect" caption="❌ Figure: Bad example – Able to select only one Project Type on Dynamics" />

<Figure src="/media/2021/08/image-1.webp" alt="Good example of a form with multiselect" caption="✅ Figure: Good example – Able to select multiple Skills from a combo box on Dynamics" />
...
<Figure src="/media/2021/08/image-2.webp" alt="" caption="Figure: A sexy report showing all the technologies used at SSW driven by our multi-select forms. This is a much better way to see trends!" />
...
<Figure src="/media/2022/02/PCF.webp" alt="" caption="Figure: PCF controls helps you easily generate intuitive interfaces, enhancing your Dynamics 365 apps" />
