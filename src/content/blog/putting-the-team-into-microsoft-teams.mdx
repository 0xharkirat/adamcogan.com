...
<Figure src="/media/2017/07/MS-teams-tabs.jpg" alt="Figure: There is a virtual smorgasbord of tabs to add the conversation – aggregating all your necessary work parts into one easy, accessible location" caption="Figure: There is a virtual smorgasbord of tabs to add the conversation – aggregating all your necessary work parts into one easy, accessible location" />
...
<Figure src="/media/2017/07/MS-teams-sharepoint-in-conversation-tabs.jpg" alt="Figure: Now we don’t need to leave the chat environment to access our files – though you can also find them on the web at https://sswcom.sharepoint.com/sites/Northwind/Shared%20Documents/" caption="Figure: Now we don’t need to leave the chat environment to access our files – though you can also find them on the web at https://sswcom.sharepoint.com/sites/Northwind/Shared%20Documents/" />

<Figure src="/media/2017/07/MS-teams-the-old-way-to-access-sharepoint.jpg" alt="Figure: Old location for files - previously, we would access our files by going to the SharePoint website" caption="Figure: Old location for files – previously, we would access our files by going to the SharePoint website" />

<Figure src="/media/2017/07/MS-teams-where-our-sharepoint-files-go.jpg" alt="Figure: New location for files - the only difference is the URL – and that these files can also be accessed directly via Teams :)" caption="Figure: New location for files – the only difference is the URL – and that these files can also be accessed directly via Teams 🙂" />
...
<Figure src="/media/2017/07/MS-Teams-notifications.jpg" alt="Figure: I’m also unsure about the placement of different notifications" caption="Figure: I’m also unsure about the placement of different notifications" />
...
<Figure src="/media/2017/07/MS-Teams-error-message.jpg" alt="Figure: I’d like to never see this again ;)" caption="Figure: I’d like to never see this again 😉" />
...
-   **Problem 10: Let me add words to spell check**
    ...
    <Figure src="/media/2017/07/MS-teams-needs-dictionary.jpg" alt="Figure: I can see that the spell checker doesn’t like certain words – but there’s no way to add them to the dictionary" caption="Figure: I can see that the spell checker doesn’t like certain words – but there’s no way to add them to the dictionary" />
