...
heroImage: "/media/2021/10/Blog-Banner-Handling-Errors.jpg"
author: "Adam Cogan"
...
<Figure src="/media/2021/10/image.png" alt="Rethrowing an exception" caption="Figure: By rethrowing a specific exception, my application code now doesn’t need to know that there is a SQL database or the magic numbers that SQL exceptions use" />
