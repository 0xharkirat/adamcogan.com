...
1.  ## Do you know what Outlook add-ins you
    ...
    <Figure src="/media/2023/12/TeamCompanionMain.jpg" alt="" caption="Figure: Good Example – Using Team Companion" />
...
2.  ## Do you use printed ‘SSW Story Cards’ with your customers in the Spec Review?
    ...
    <Figure src="/media/2023/12/SSWStoryCard.jpg" alt="SSW Story Card" caption="Figure: SSW Story Card" />
...
3.  ## Dones – Do you reply ‘Done – changeset xxx’ (bad example using TFS instead of TeamCompanion)
    ...
    1.  When the work item is completed opens up the work item and opens the original attachment
        ...
        <Figure src="/media/2023/12/TFSWA_CompleteWI_Step1.jpg" alt="Open original email from work items" caption="Figure: Bad Example – Open work item and select file attachments, then open the original email request (using TFSWA)" />
    ...
    3.  Save “done” email as msg file to a local folder
        ...
        <Figure src="/media/2023/12/TFSWA_CompleteWI_Step4.jpg" alt="Attach done email into the work item" caption="Figure: Bad Example – Attach ‘done’ email back against the work item (using TFSWA)" />

    4.  Change the status of the work item and update the hours worked

        <Figure src="/media/2023/12/TFSWA_CompleteWI_Step5.jpg" alt="Close work items with actual hours spent." caption="Figure: Bad Example – Change Status to ‘Closed’, add hours to worked completed and change remaining hours to 0 (using TFSWA)" />
...
5.  ## Dones – Move the email from your inbox to a TFS Work Item (via an Outlook Addin)
    ...
    <Figure src="/media/2023/12/TFS_OAdd_01.jpg" alt="Converting email to TFS with TeamCompanion" caption="Figure: Convert the email into a TFS work item by click TeamCompanion’s ‘New Work Item from Mail’ button" />

    <Figure src="/media/2023/12/TFS_OAdd_02.jpg" alt="Converting email to TFS with TeamCompanion" caption="Figure: The original email will be attached to the TFS work item so you have the original (plus all the rich formatting in the email)" />
...
6.  ## Done – Do you fix/update the TeamCompanion template, so the email “subject” doesn’t
    ...
    <Figure src="/media/2023/12/TFS_SendMail_Option1.jpg" alt="Send Email option" caption="Figure: The default template changes the subject" />

    To

    <Figure src="/media/2023/12/TFS_SendMail_Option.jpg" alt="Send Email option" caption="Figure: Change the New Email subject to be ‘RE: {System.Title}’ so the subject does not change" />
...
7.  ## Dones – Do you fix/update the TeamCompanion template, so the email “history” looks
    ...
    <Figure src="/media/2023/12/TFS_SendMail_Option2.jpg" alt="Send Email option" caption="Figure: Change the “New e-mail body:” so you can generate a proper “done” mail" />
...
9.  ## Dones – Do you reply ‘Done – changeset xxx’? (4 step of using TeamCompanion instead of plain TFS)
    ...
    **Note:** Make sure you have followed rule “Dones – Move the email from your inbox to a TFS Work Item (via an Outlook Addin)” to create work items in TFS. If you followed this rule then you have attached the original email to the work item.
    ...
    -   Open the work item
        ...
        <Figure src="/media/2023/12/open-work-item.jpg" alt="Work Item File Attachments" caption="Figure: Open the work item using Team Companion" />
    ...
    -   Open the email in attachments hit ‘Reply’ to this email and copy the email history (we will use the history of this email in our “Done” email).
        ...
        <Figure src="/media/2023/12/email-clipboard.jpg" alt="Replied original request email as the history" caption="Figure: Once opened, Control+A, Control+C to copy the email history to the clipboard" />

    **Step 2: Choose “Done”**

    <Figure src="/media/2023/12/choose-done.jpg" alt="Generate done mail template" caption="Choose “Done”" />

    You will see that the following Windows, check “Send done e-mail” and click “OK”

    <Figure src="/media/2023/12/done-window.jpg" alt="Generate done mail template" caption="Figure: The done windows from Team Companion that will close the work item from you" />
    ...
    **Note:** You should not do it the other way around as TeamCompanion will not attach it back to the work item.
    ...
    <Figure src="/media/2023/12/TFS_4StepDone_5.jpg" alt="Proper done mail" caption="Figure: Wooolaaaah… The properly formatted “done” email" />
    ...
    **Step 4: Send the done email (and TeamCompanion close the work item in the current backlog)**
    ...
    <Figure src="/media/2023/12/done-attachment.jpg" alt="File Attachments" caption="Figure: You will now have the attachments – the “Done” email" />

    And the work item is now closed.

    <Figure src="/media/2023/12/closed-work-item.jpg" alt="work item is closed" caption="Figure: The work item is closed in TFS 2012" />

10.  ## Initializing the Project – Do you get the work items into TFS via Excel

     -   Open SSW Priorities Estimate Template in Excel

         <Figure src="/media/2023/12/ExcelSSWTemplate.jpg" alt="Find SSW Template - 'New | My templates... | SSW_Proposal-Project | SSWPrioritiesEstimateTemplate.xltx'" caption="Figure: Find SSW Template – ‘New | My templates… | SSW_Proposal-Project | SSWPrioritiesEstimateTemplate.xltx’" />

     -   Add the tasks and additional tasks into Release\_XX sheet

         <Figure src="/media/2023/12/ExcelReleaseSheet.jpg" alt="Copy work items to Release_XX sheet" caption="Figure: Copy work items to Release_XX sheet" />
     ...
     -   Click “New List” and choose your project
         ...
         <Figure src="/media/2023/12/ExcelFindProject.jpg" alt="Find your project in the list" caption="Figure: Find your project in the list" />

         <Figure src="/media/2023/12/ExcelInputList.jpg" alt="Choose 'Input list' to download the empty template" caption="Figure: Choose ‘Input list’ to download the empty template" />

     -   Add the other useful columns e.g. Baseline Work, Remaining Work, Completed Work
         into Excel

         <Figure src="/media/2023/12/ExcelChooseColumnsButton.jpg" alt="Click 'Choose columns'" caption="Figure: Click ‘Choose columns’" />

         <Figure src="/media/2023/12/ExcelChooseColumnsList.jpg" alt="Select columns in the left list" caption="Figure: Select columns in the left list" />

     -   Copy work items (including the Project Management tasks) from Release\_XX to the new sheet

         <Figure src="/media/2023/12/ExcelWorkItems.jpg" alt="Copy work items from Release_XX" caption="Figure: Copy work items from Release_XX" />
...
11.  ## Triage the work item
     ...
     <Figure src="/media/2023/12/TFS_TW_01.jpg" alt="Assign the converted task to an interation" caption="Figure: Triage the work item. Aim to assign the task to a future iteration" />
...
12.  ## What if this is a related work item?
     ...
     -   If the request is a bug from a closed work item that needs to be re-opened
         ...
         <Figure src="/media/2023/12/TFSWA_AttachFile.jpg" alt="Close work items with actual hours spent." caption="Figure: Bad Example – Work Item is re-opened and email added to attachments (using TFSWA)" />

         <Figure src="/media/2023/12/TeamCompanionAttachEmail.jpg" alt="Attach Email - Team Companion" caption="Figure: Good Example – Work Item is re-opened and email added to the attachments (using Team Companion)" />
...
13.  ## Do you know what to do with a duplicate? (aka Linking Work Items)
     ...
     <Figure src="/media/2023/12/TFSWA_LinkWorkItem.jpg" alt="Add link between work items" caption="Figure: Bad Example – Add the link between the two work items, you will be prompted for search options to locate the related item (using TFSWA)" />

     <Figure src="/media/2023/12/TFSWA_FindWorkItem.jpg" alt="Locate Work Item" caption="Figure: Bad Example – Locate original work item from your work items list (using TFSWA)" />

     <Figure src="/media/2023/12/TFSWA_LinkWorkItemComplete.jpg" alt="Locate Work Item" caption="Figure: Bad Example – Link has been added and you can save the new work item (using TFSWA)" />

     Team Companion provides an easy way to link with an existing work item.

     <Figure src="/media/2023/12/TeamCompanionOpenWorkItem.jpg" alt="Open the existing work item" caption="Figure: Good Example – Open an existing work item from work item list (using Team Companion)" />

     <Figure src="/media/2023/12/TeamCompanionAddRelatedWI.jpg" alt="Create related work item" caption="Figure: Good Example – Link has been added to the new created work item (using Team Companion)" />
...
14.  ## Do you use the Implementation tab to organize your requirements hierarchy?
     ...
     <Figure src="/media/2023/12/Agile5LinkTypes.jpg" alt="Link types" caption="Figure:Child/Parent link types" />
     ...
     <Figure src="/media/2023/12/Agile4LinkTab.jpg" alt="Agile 4 Links tab" caption="Figure: Bad Example – The old Agile template only provides “related” links" />

     <Figure src="/media/2023/12/Agile5ImpTab.jpg" alt="Agile 5 Implementation tab" caption="Figure: Good Example – Using the “Implementation” tab to organize hierarchy by using “Child” link type" />
...
15.  ## Do you avoid creating multiple Team Projects for the same project?
     ...
     <Figure src="/media/2023/12/BadMultipleProject.gif" alt="Bad Multiple Project Example" caption="Figure: Bad Example – Multiple Team Projects for the same product" />

     <Figure src="/media/2023/12/GoodMultipleProject.gif" alt="Good Multiple Project Example" caption="Figure: Good Example – Multiple solution folders in the same Team Project" />

16.  ## Reports – Do you know how to create a sprint backlog (was release plan) with TFS?

     <Figure src="/media/2023/12/Scrum-Overview-Diagram-Update-Product-Backlog.jpg" alt="The Update Product Backlog Stage" caption="Figure: At this point, you are at “Update Product Backlog” stage" />
     ...
     1.  1.  Open your team project in Visual Studio
         ...
         2.  Create a new TFS iteration for your sprint
             **Tip:** Go to Visual Studio | Team | Team Project Settings | Areas and Iterations
             ...
             <Figure src="/media/2023/12/AreasAndIterations.png" alt="Create Iteration in TFS" caption="Figure: Create Iteration in TFS" />
     ...
     1.  1.  Create an email as per Do you have a contract between Product Owner and the Team?
         2.  In your email add the tasks
             **Tip:** Attach a PDF of the Story Overview report
             ...
             <Figure src="/media/2023/12/StoriesOverviewReport.jpg" alt="Stories Overview Report" caption="Figure: Open the ‘Stories Overview Report’ and attach .pdf in your sprint contract (was ‘Release Plan’ email)" />
...
17.  ## Do you know how to create a Release Update/Debrief report with TFS?
     ...
     -   Go to TFS report server and open report folder of your team project, generate project Update/Debrief from SSW Release Update
         ...
         <Figure src="/media/2023/12/TFS_UP_01.jpg" alt="release update/debrief report" caption="Figure: SSW Release Update report" />
...
19.  ## Do you know how to find the URL of a task?
     ...
     -   Find and click on your task
         ...
         <Figure src="/media/2023/12/FindYourTask.png" alt="Find your task" caption="Figure: Find your task" />
...
20.  ## Do you know about the nice URLs for TFS Web Access?
     ...
     <Figure src="/media/2023/12/TSWALinkCreator.jpg" alt="TSWA Link Creator" caption="Figure: Create nice URL by TSWA Link Auditor" />
...
21.  ## Do you know how to refresh the cube?
     ...
     <Figure src="/media/2023/12/StaleData.jpg" alt="The TFS Warehouse needs to be updated." caption="Figure: The report footer tells you that the TFS Warehouse is not up to date" />
     ...
     **Option 2.** Open the TFS Web Services in IE and then force processing (Recommended – see below)
     ...
     7.  Browse to http://localhost:8080/tfs/TeamFoundation/Administration/v3.0/WarehouseControlService.asmx
         ...
         <Figure src="/media/2023/12/WebService.jpg" alt="Warehouse Control web services" caption="Figure: You will need to call 2 of these web services" />

     8.  Invoke “ProcessWarehouse” with the parameter “DefaultCollection” (or whatever your collection is called)

         <Figure src="/media/2023/12/ProcessWarehouse.jpg" alt="Process Warehouse" caption="Figure: Call “ProcessWarehouse” web service with paramter “DefaultCollection”" />

     9.  Invoke “ProcessAnalysisDatabase” with parameter “Full”

         <Figure src="/media/2023/12/ProcessAnalysisDatabase.jpg" alt="Process Analysis Database" caption="Figure: Call “ProcessAnalysisDatabase” with paramter “Full”" />
...
22.  ## Do you explain the 3 concepts to a client?
     ...
     **Step 1: Line up some ducks**
     ...
     ![Ducks in row](/media/2023/12/ducksinrow.jpg)
     ...
     <Figure src="/media/2023/12/filledStoryCard.jpg" alt="Filled Story Card" caption="Figure: Clear concise requirements captured in a User Story Card" />

     **Step 2: Do a few practice shots**

     ![Target](/media/2023/12/target.jpg)
     ...
     **Step 3: Do it for real (start the race)**
     ...
     ![startofrace](/media/2023/12/startofrace.jpg)
...
23.  ## Do you know when to create the team project and ‘TFS Portal’ for a prospect/client?
     ...
     <Figure src="/media/2023/12/CreateNewSPSite.jpg" alt="Create New SP Site" caption="Figure: Choose to create a new SharePoint site when creating TFS project" />
     ...
     <Figure src="/media/2023/12/AddImgToTeamSite.jpg" alt="Add an image To Team Site once the TFS portal is ready" caption="Figure: Once your ‘TFS Portal’ is ready, add a picture of the team site, prior to letting them know about the new site" />
...
25.  ## Do you know how to get SharePoint 2010 working with TFS 2010?
     ...
     <Figure src="/media/2023/12/SPWithTFS2010.jpg" alt="Dashboards take the guessing out of the Project Planning and estimation" caption="Figure: Dashboards take the guessing out of Project Planning and estimation. Plus writing these reports would be boring!" />
...
26.  ## Do you know how to make a better subject and keep threading using TeamCompanion?
     ...
     <Figure src="/media/2023/12/KeepTreading-Bad.jpg" alt="" caption="Figure: Bad Example – The Title is totally changed and the treading is broken" />

     <Figure src="/media/2023/12/KeepTreading-Good.jpg" alt="" caption="Figure: Good Example – Keep the old Title to keep the threading" />

27.  ## Do you check that the 3 services are running on their own AD accounts?

     <Figure src="/media/2023/12/DefaultAdministrationAccount.jpg" alt="Default Administrator account" caption="Figure: Bad example – using the default Administrator account" />

     <Figure src="/media/2023/12/CreateNewAccount.jpg" alt="Create new account" caption="Figure: Better example – At least don’t use the Administrator account, create a new account" />

     <Figure src="/media/2023/12/SpecificADAccount.jpg" alt="Specific AD Account" caption="Figure: Best example – A specific AD account for each major server" />

     <Figure src="/media/2023/12/NetworkAdminName.jpg" alt="Network admin name" caption="Figure: Bad example – using the network admin’s name" />

     <Figure src="/media/2023/12/SQLServerAccount.jpg" alt="SQL Server Account" caption="Figure: Good example – a specific SQL Server account being used (Suggestion: Make the text box wider and link to the one in ‘Services’)" />
...
28.  ## Do you know to use SharePoint over SharePoint Foundation for TFS?
     ...
     <Figure src="/media/2023/12/ProjectDashboard.jpg" alt="Project Dashboard - limited dashboard and reports" caption="Figure: OK Example – Using SharePoint Foundation you get limited dashboards and reports" />

     <Figure src="/media/2023/12/BugDashboard.jpg" alt="Bug Dashboard" caption="Figure: Ultimate example – The bug dashboard gives you easy access to all the data" />
...
29.  ## Do you know wither to use a Wiki or Document Library?
     ...
     <Figure src="/media/2023/12/TeamInfomation.jpg" alt="Add team information" caption="Figure: Always add team information to a Wiki and Client communication to the Document Library" />
...
30.  ## Do you know where to keep server details
     ...
     <Figure src="/media/2023/12/WikiExample.jpg" alt="Wiki is a good example for editing" caption="Figure: Good example – Things on a Wiki can easily be edited and quickly checked" />
