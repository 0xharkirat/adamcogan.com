...
heroImage: "/media/2024/12/Blog-Banner-GitHub-Update.png"
author: "Adam Cogan"
...
<Figure src="/media/2024/12/Original-Useage.jpg" alt="" caption="Figure: In 2022 at SSW 48% of developers were not using Copilot at all, 27% were using it weekly" />

Now at the end of 2024, just about every coder at SSW is using AI to help them write, understand, and summarise code.

<Figure src="/media/2024/12/image-1.png" alt="Bar Chart of 2024 survey" caption="Figure: You can see in 2024 that 0 developers aren’t using it at all, while 89% of developers are now using it weekly" />
...
<Figure src="/media/2024/12/ai-tools.jpg" alt="" caption="Figure: A survey of how much SSW’ers use AI and which tools" />

<Figure src="/media/2024/12/image-3.png" alt="Bar Chart of results from GitHub research of Accenture devs" caption="Figure: From the developers at Accenture who were surveyed, more than 50% found it “extremely” helpful" />
