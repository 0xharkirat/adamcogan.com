...
heroImage: "/media/2022/06/Blog-Banner-GitHub-.webp"
author: "Adam Cogan"
...
<Figure src="/media/2022/06/image-3.webp" alt="Power Automate Templates" caption="Figure: Microsoft Power Automate templates selection" />
...
<Figure src="/media/2022/06/image-2.webp" alt="Example Flow with Salesforce" caption="Figure: a simple flow in Power Automate with Salesforce. Source" />
...
<Figure src="/media/2022/06/image-1.webp" alt="Nice example of a well ordered Flow" caption="Figure: Good example – complex logic is put into Azure Functions & Step names use the default name with a brief description of what it does" />
...
<Figure src="/media/2022/06/image-4.webp" alt="A neat ordered Flow" caption="Figure: Good example – a Group of Actions inside a Scope – nice and neat!" />
