...
<Figure src="/media/2016/04/01-interest-in-Angular-over-time.jpg" alt="interest in Angular over time" caption="Figure: Angular is the number #1 JavaScript frameworks, with only React even registering as competition." />
...
<Figure src="/media/2016/04/02-angular-is-modular.jpg" alt="angular 2.0 is component-based" caption="Figure: Angular 2.0 user interfaces are built on a series of components just like Lego" />
...
<Figure src="/media/2016/04/03-angular-learning-squiggle.jpg" alt="angular learning curve" caption="Figure: Learning Angular 1.0 was a mix of excitement and pain." />
...
<Figure src="/media/2016/04/04-packed-out-angular-2-course.jpg" alt="packed out angular 2.0 course" caption="Figure: Our two-day Angular 2.0 training courses were sold out in Sydney, Melbourne, and Brisbane twice" />
...
![pluralsight](/media/2016/04/pluralsight.jpg)
...
![FBC-Angular-banner](/media/2016/04/FBC-Angular-banner.jpg)
