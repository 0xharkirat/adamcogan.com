...
heroImage: "/media/2021/06/Blog-Banner-Keeping-Secrets.jpg"
author: "Adam Cogan"
...
<Figure src="/media/2021/06/image.png" alt="Graph showing the most popular connection string storage methods" caption="Figure: Good to see no one is hardcoding secrets at SSW (no blue)! Most prefer using Key Vault (red)" />
...
![Detecting if your application is on your local machine or on an Azure AppService](/media/2021/06/image-2.png)
