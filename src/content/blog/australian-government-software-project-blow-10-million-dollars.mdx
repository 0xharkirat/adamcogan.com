...
heroImage: "/media/2016/07/10-million-dollars-banner.png"
author: "Adam Cogan"
...
<Figure src="/media/2016/06/img_1341.png" alt="A page from the User Guide - attribute based data can be stored." caption="Figure: A page from the User Guide – attribute based data can be stored." />

<Figure src="/media/2016/06/img_1340.png" alt="A page from the User Guide - you can do a mail merge" caption="Figure: A page from the User Guide – you can do a mail merge" />
...
<Figure src="/media/2016/06/feedbackapp.png" alt="Figure: You can record all sorts of information about a constituent. E.g. Anti gay-marriage (3rd last record above)" caption="Figure: You can record all sorts of information about a constituent. E.g. Anti gay-marriage (3rd last record above)" />

<Figure src="/media/2016/06/feedbackapp2.png" alt="Figure: User Interface of the desktop application is definitely “old school”" caption="Figure: User Interface of the desktop application is definitely “old school”" />
