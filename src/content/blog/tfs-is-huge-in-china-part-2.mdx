...
<Figure src="/media/2013/08/IIS-Maximum-Worker-Processes.webp" alt="IIS-Maximum-Worker-Processes" caption="Figure: We found increasing the setting of IIS’s Maximum Worker Processes to “7” gave us the best results." />
...
<Figure src="/media/2013/07/performance-wizard.webp" alt="Figure: Run the Visual Studio Performance Wizard (in VS 2010 and VS 2012)" caption="Figure: Run the Visual Studio Performance Wizard (in VS 2010 and VS 2012)" />

<Figure src="/media/2013/07/performance-diag.webp" alt="Figure: Or choose the “Performance and Diagnostics” menu in VS 2013" caption="Figure: Or choose the “Performance and Diagnostics” menu in VS 2013" />

Here is the 1st report we saw:

<Figure src="/media/2013/07/performance-report.webp" alt="Figure: Our 1st performance profiling report identifies the bottleneck is NewWorkItem()" caption="Figure: Our 1st performance profiling report identifies the bottleneck is NewWorkItem()" />
...
<Figure src="/media/2013/07/perflistener.webp" alt="Figure: Tracing TFS Web Service calls show the most accessed methods, which was our starting point" caption="Figure: Tracing TFS Web Service calls show the most accessed methods, which was our starting point" />
