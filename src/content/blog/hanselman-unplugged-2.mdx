...
Last week was awesome! [NDC Sydney](http://ndcsydney.com/) was such a fantastic event. It was super well-run by the Vikings from Norway + SSW was well represented with 2 cool stands at the conference and 4 speakers. We had [Adam Stephensen (aka Stevo)](https://sharepoint.ssw.com.au/AboutUs/Employees/Pages/AdamS.aspx) and [Duncan Hunter](https://sharepoint.ssw.com.au/AboutUs/Employees/Pages/DuncanHunter.aspx) from our Brisbane office + [Danijel Malik](https://sharepoint.ssw.com.au/AboutUs/Employees/Pages/Danijel-Malik.aspx) and [myself](https://sharepoint.ssw.com.au/AboutUs/Employees/Pages/Adam.aspx) from Sydney. We spoke on a range of topics from Angular 2 best practices to .NET Core and DevOps.
