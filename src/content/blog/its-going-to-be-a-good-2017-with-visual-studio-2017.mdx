...
<Figure src="/media/2017/02/Visual-Studio-2017-Installer-.jpg" alt="Figure: The new Visual Studio 2017 Installer showing the different workloads. We usually choose “Web development”." caption="Figure: The new Visual Studio 2017 Installer showing the different workloads. We usually choose “Web development”." />
...
### ![VS-loading](/media/2017/02/VS-loading.jpg)The death of VB.NET
...
<Figure src="/media/2017/02/Google-trends-Csharp-VB-NET-AngularJS.jpg" alt="Figure: Google trends for C#, VB.NET and AngularJS. Shows the decline of VB.NET and rise of Angular" caption="Figure: Google trends for C#, VB.NET and AngularJS. Shows the decline of VB.NET and rise of Angular" />
...
<Figure src="/media/2017/02/bad-example-using-ctrl-shift-f.jpg" alt="Figure: Bad Example – Using CTRL + SHIFT + F to find all in the solution gives a wall of text" caption="Figure: Bad Example – Using CTRL + SHIFT + F to find all in the solution gives a wall of text" />
...
<Figure src="/media/2017/02/better-example-using-ctrl-semicolon.jpg" alt="Figure: Better Example – Using CTRL + ; searching in the Solution Explorer window" caption="Figure: Better Example – Using CTRL + ; searching in the Solution Explorer window" />

Now Visual Studio 2017 it introduces Go to All with CTRL + T

<Figure src="/media/2017/02/good-example-using-go-to-all.jpg" alt="Figure: Good Example – Using Go To All to quickly find what you’re after" caption="Figure: Good Example – Using Go To All to quickly find what you’re after" />
...
<Figure src="/media/2017/02/go-to-line-integrated.jpg" alt="Figure: Go To Line has been integrated into the Go to All search box" caption="Figure: Go To Line has been integrated into the Go to All search box" />
...
<Figure src="/media/2017/02/app-insights-data-in-CodeLens.jpg" alt="Figure: App Insights data now showing in CodeLens" caption="Figure: App Insights data now showing in CodeLens" />
