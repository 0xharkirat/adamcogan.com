...
heroImage: "/media/2021/12/Blog-Banner-GitHub-Issues-1.jpg"
author: "Adam Cogan"
...
<Figure src="/media/2021/12/image.png" alt="Good example of nice backlog" caption="Figure: Good Example – A nicely organised and labelled Backlog with emojis that help convey the task" />
...
<Figure src="/media/2021/12/image-4.png" alt="Bad example of GitHub Project labels" caption="Figure: Bad Example – using Effort labels is not ideal since the release of the new GitHub Projects" />

<Figure src="/media/2021/12/image-5.png" alt="Good example of GitHub Porject Labels" caption="Figure: Good Example – Add a few labels beyond the ones that are set based on the Issue Templates" />
...
<Figure src="/media/2021/12/image-6.png" alt="Kevin Hart meme" caption="Figure: Most of my devs think Emoji’s on labels is just too much!" />
