...
heroImage: "/media/2024/08/7-Important-Updates-to-TinaCMS-Blog-Banner.jpg"
author: "Adam Cogan"
...
<Figure src="/media/2024/08/LLama.jpg" alt="Adam and a llama" caption="Figure: Me and one of the Tina Llamas from the launch party – like the product, they are very friendly" />
...
<Figure src="/media/2024/08/Image-1.png" alt="The Code with the configuration with 3 buttons (heading, bold, italic)" caption="Figure: Here you can see the configuration with 3 buttons (heading, bold, italic)" />

<Figure src="/media/2024/08/image2.png" alt="Screen image showing only 3 buttons showing in a situation where a minimal amount of text customization is desired (users can't even add images)" caption="Figure: Only 3 buttons showing in a situation where a minimal amount of text customization is desired (users can’t even add images)" />
...
<Figure src="/media/2024/08/image3.png" alt="Showing the new file format" caption="Figure: Whatever file format you want you can have, even .MKV" />
...
<Figure src="/media/2024/08/image4.png" alt="Showing Tina on various screens" caption="Figure: You can now use TinaCMS on the go" />
