...
heroImage: "/media/2019/12/AdamsBlog-8TipsToStrenghthenYourDevOps.jpg"
author: "Adam Cogan"
categories: ["general"]
tags: []
...
<Figure src="/media/2019/12/image-1.png" alt="" caption="Figure: On the left of the screenshot it shows the different machinery and the project noise levels. On the right it shows the affected properties. Red is very bad, yellow is noisy, green is good." />

<Figure src="/media/2019/12/image.png" alt="" caption="Figure: In this screenshot the red indicates a large cluster of houses that will be seriously affected by noise. If there is night time work, then the occupants would need accommodation." />
